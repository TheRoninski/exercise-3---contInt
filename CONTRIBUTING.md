# Contributing to @roninski/password-utilities
...
1. **Clone the repository**:
   ...
   git clone https://github.com/TheRoninski/exercise-3---contInt.git
   ```
...
- **Commit Message Format**: Commit messages should be descriptive, e.g., `feat: add new string manipulation` following

  the [Conventional Commits Specification](https://www.conventionalcommits.org/en). It is easy to follow if you are using the [semantic-git-commit-cli](https://www.npmjs.com/package/semantic-git-commit-cli)
